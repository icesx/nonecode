...
./configure --prefix=/home/bjrdc/software/nagios-4.4.5 --with-nagios-group=bjrdc --with-nagios-user=bjrdc --with-httpd-conf=/etc/apache2/sites-enabled
make all -j8
make install
make install-config
...
./configure --prefix=/home/bjrdc/software/nrpe-3.2.1 --with-nrpe-group=bjrdc --with-nrpe-user=bjrdc --with-nagios-user=bjrdc --with-nagios-group=bjrdc
make all
make install-plugin
...
define service{
       ...
       check_command                   check_local_disk!20%!10%!/moa
       }
define service{
       use                             local-service
       host_name                       bjrdc100
